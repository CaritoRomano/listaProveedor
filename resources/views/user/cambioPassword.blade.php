                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('user/updatePassword') }}">
                        ...
                        <div class="form-group{{ $errors->has('passwordActual') ? ' has-error' : '' }}">
                            <label for="passwordActual" class="col-md-4 control-label">Contrase&ntilde;a Actual</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if(!empty($mensaje))
                                        <div class="aprobado right"> <label> {{ $mensaje }} </label></div>
                                @endif            
                                </div>
                            </div>
                        </div>
